...
public:
    ...
    void array_rm(size_type index);
    void array_mf(size_type index,element_type value);
private:
...
void array::array_rm(size_type index) {
...
void array::array_mf(size_type index,element_type value) { 
